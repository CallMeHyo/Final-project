...
(A) .Rmd Line numbers where at least two different data sources are imported:  line 29 - 30


(B) .Rmd Line numbers for inspecting data intake: line 37,38,45,46
...
(A) .Rmd Line number(s) for general data wrangling: basically every chunk, for the sake of the example, line 73-77


(B) .Rmd Line number(s) for a join operation:  line 61


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): line 146, I used pivot_longer() function to accomplish this.


(D) .Rmd Line number(s) for use of regular expressions: None


(E) .Rmd Line number(s) for use of reduction and/or transformation functions:  used extensively through out the project, for an example, line 165 - 169


(F) .Rmd Line number(s) for use of user-defined functions: None


(G) .Rmd Line number(s) for use of loops and/or control flow: None


(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): line 175
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  line 94 - 97

(B) .Rmd Line number(s) for use of multiple aesthetics:  line 147 - 149

(C) .Rmd Line number(s) for use of layered graphics:  line 94 - 97, line 147 - 149

(D) .Rmd Line number(s) for use of leaflet maps: None

(E) .Rmd Line number(s) for use of decision tree or dendogram results:  line 176
